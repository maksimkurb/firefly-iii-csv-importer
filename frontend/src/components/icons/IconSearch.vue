<!-- This icon is from <https://www.iconfinder.com/icons/4552616/glass_loupe_magnifier_magnifying_magnifying_glass_search_seo_icon>, distributed Free for commercial use -->
<template>
  <svg
